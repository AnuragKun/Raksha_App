package com.arlabs.raksha.Presentation.HomeScreen
...
fun HomeScreen(){
    ...
    Scaffold { innerPadding->
        GradientBox(modifier = Modifier.fillMaxSize()) {
            Column (modifier = Modifier.fillMaxSize().align (Alignment.TopStart).padding(innerPadding),
            ...
            Column (modifier = Modifier.align(Alignment.Center).padding(innerPadding),
            verticalArrangement = Arrangement.Top,
